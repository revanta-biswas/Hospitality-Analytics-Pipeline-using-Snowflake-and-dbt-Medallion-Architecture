...
4. The finding MUST be logged in `runtime-artifacts/audit.md` with the RESILIENCY rule ID, description, and stage context
...
C) Defer execution — capture test scenarios now, execute later as post-release operational work (tracked as a follow-up).
