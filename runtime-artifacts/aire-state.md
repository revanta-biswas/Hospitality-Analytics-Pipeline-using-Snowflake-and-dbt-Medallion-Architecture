...
|-------|-------|----------|------------|--------|----|--------|-------|-----|----------|
| 1.1 | Replace inline AWS credentials with a Snowflake Storage Integration | none | #1 | 🔵 In Development | [#11](https://github.com/revanta-biswas/Hospitality-Analytics-Pipeline-using-Snowflake-and-dbt-Medallion-Architecture/pull/11) | yes | 2026-09-14 | | 2026-09-16 10:45 |
| 1.2 | Externalize dbt connection secrets via environment variables | none | #2 | 🔵 In Development | [#12](https://github.com/revanta-biswas/Hospitality-Analytics-Pipeline-using-Snowflake-and-dbt-Medallion-Architecture/pull/12) | yes | 2026-09-15 | | 2026-09-16 10:55 |
| 1.3 | Add core data integrity tests (uniqueness, not-null, referential integrity) | none | #3 | 🔵 In Development | — | — | 2026-09-16 | | 2026-09-16 10:55 |
