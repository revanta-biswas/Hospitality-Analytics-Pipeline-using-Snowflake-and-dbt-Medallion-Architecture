...
Section 4). Importing each module here registers its @given/@when/@then
...
(__init__.py) exists under tests/, so the steps modules are loaded by path
...
from profile_secrets_steps import *  # noqa: F401,F403,E402
